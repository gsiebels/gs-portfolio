        ...
        <div className="project">
          <div className="project-info">
            <div className="details">                  
              ...
              <a className="p-button" href="https://mobile-hairhub.herokuapp.com/">Launch</a>
              <a className="p-button" href="https://github.com/gsiebels/project-hair/blob/master/README.md"><img className="link" src="https://konpa.github.io/devicon/devicon.git/icons/github/github-original.svg" alt="github link" /></a>
              </div>
            </div>
        ...
        <div className="project">
          <div className="project-info">
            <div className="details">                  
              ...
              <div className="buttons">
              <a className="p-button" href="https://find-your-local-unicorn.herokuapp.com/">Launch</a>
              <a className="p-button" href="https://github.com/gsiebels/sei-group-project/blob/master/README.md"><img className="link" src="https://konpa.github.io/devicon/devicon.git/icons/github/github-original.svg" alt="github link" /></a>
              </div>
            </div>
        ...
        <div className="project">
          <div className="project-info">
            <div className="details">                  
              ...
              <div className="buttons">
                <a className="p-button" href="https://rick-and-morty-fun-page.herokuapp.com/">Launch</a>
                <a className="p-button" href="https://github.com/gsiebels/sei-project-2/blob/master/README.md"><img className="link" src="https://konpa.github.io/devicon/devicon.git/icons/github/github-original.svg" alt="github link" /></a>
              </div>
            </div>
        ...
        <div className="project">
          <div className="project-info">
            <div className="details">                  
              ...
              <div className="buttons">
                <a className="p-button" href="http://gsiebels.github.io/project-01/">Launch</a>
                <a className="p-button" href="https://github.com/gsiebels/project-01/blob/master/README.md"><img className="link" src="https://konpa.github.io/devicon/devicon.git/icons/github/github-original.svg" alt="github link" /></a>
              </div>
            </div>
